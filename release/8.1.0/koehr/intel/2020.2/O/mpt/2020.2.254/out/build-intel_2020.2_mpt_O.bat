#!/bin/bash -l
#PBS -N build-intel_2020.2_mpt_O.bat
#PBS -j oe
#PBS -q standard
#PBS -A NRLMR03795024
...
cd /p/work1/mpotts/intel_2020.2_mpt_O
...
export ESMF_DIR=/p/work1/mpotts/intel_2020.2_mpt_O
...
ssh koehr01 /p/work1/mpotts/intel_2020.2_mpt_O/getres-build.sh
