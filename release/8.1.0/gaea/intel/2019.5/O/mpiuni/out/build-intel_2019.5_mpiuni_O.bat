...
#SBATCH --time=1:00:00
#SBATCH --exclusive
#SBATCH --output build-intel_2019.5_mpiuni_O.bat_%j.o
export JOBID=$SLURM_JOBID
export ESMF_MPIRUN=/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_O/src/Infrastructure/stubs/mpiuni/mpirun
...
export ESMF_DIR=/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_O
