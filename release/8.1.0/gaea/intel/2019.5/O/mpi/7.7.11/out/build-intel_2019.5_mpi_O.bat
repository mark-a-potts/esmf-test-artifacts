...
#SBATCH --time=1:00:00
#SBATCH --exclusive
#SBATCH --output build-intel_2019.5_mpi_O.bat_%j.o
export JOBID=$SLURM_JOBID
set -x
module load intel/19.0.5.281 pmi/5.0.15 cray-netcdf/4.6.3.2
...
export ESMF_DIR=/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpi_O
