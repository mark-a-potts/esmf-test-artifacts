...
cd /glade/scratch/mpotts/gfortran_10.1.0_mpt_g
...
export ESMF_DIR=/glade/scratch/mpotts/gfortran_10.1.0_mpt_g
...
ssh cheyenne6 /glade/scratch/mpotts/gfortran_10.1.0_mpt_g/getres-build.sh
