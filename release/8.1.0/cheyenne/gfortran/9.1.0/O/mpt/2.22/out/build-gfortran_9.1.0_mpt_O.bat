...
cd /glade/scratch/mpotts/gfortran_9.1.0_mpt_O
...
export ESMF_DIR=/glade/scratch/mpotts/gfortran_9.1.0_mpt_O
...
ssh cheyenne6 /glade/scratch/mpotts/gfortran_9.1.0_mpt_O/getres-build.sh
