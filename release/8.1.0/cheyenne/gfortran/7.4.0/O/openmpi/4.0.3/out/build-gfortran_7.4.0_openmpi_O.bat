...
cd /glade/scratch/mpotts/gfortran_7.4.0_openmpi_O
...
export ESMF_DIR=/glade/scratch/mpotts/gfortran_7.4.0_openmpi_O
...
ssh cheyenne6 /glade/scratch/mpotts/gfortran_7.4.0_openmpi_O/getres-build.sh
