...
ESMF_APPSDIR=/scratch/cluster/mpotts/intel_19.1.0.166_mpiuni_g/apps/appsg/Linux.intel.64.mpiuni.default
ESMF_LIBSDIR=/scratch/cluster/mpotts/intel_19.1.0.166_mpiuni_g/lib/libg/Linux.intel.64.mpiuni.default
...
ESMF_F90LINKPATHS=-L/scratch/cluster/mpotts/intel_19.1.0.166_mpiuni_g/lib/libg/Linux.intel.64.mpiuni.default -L/usr/local/netcdf-c-4.7.4-f-4.5.2-intel-cluster-20.0.1/lib -L/usr/local/netcdf-c-4.7.4-f-4.5.2-intel-cluster-20.0.1/lib -L/usr/local/hdf5-1.12.0-intel-cluster-20.0.1/lib -L/usr/local/netcdf-c-4.7.4-f-4.5.2-intel-cluster-20.0.1/lib 
ESMF_F90ESMFLINKPATHS=-L/scratch/cluster/mpotts/intel_19.1.0.166_mpiuni_g/lib/libg/Linux.intel.64.mpiuni.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/scratch/cluster/mpotts/intel_19.1.0.166_mpiuni_g/lib/libg/Linux.intel.64.mpiuni.default -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-intel-cluster-20.0.1/lib -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-intel-cluster-20.0.1/lib -Wl,-rpath,/usr/local/hdf5-1.12.0-intel-cluster-20.0.1/lib -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-intel-cluster-20.0.1/lib
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/scratch/cluster/mpotts/intel_19.1.0.166_mpiuni_g/lib/libg/Linux.intel.64.mpiuni.default
...
ESMF_CXXCOMPILEPATHS= -I/scratch/cluster/mpotts/intel_19.1.0.166_mpiuni_g/src/include  -I/usr/local/netcdf-c-4.7.4-f-4.5.2-intel-cluster-20.0.1/include -I/scratch/cluster/mpotts/intel_19.1.0.166_mpiuni_g/src/Infrastructure/stubs/mpiuni -I/scratch/cluster/mpotts/intel_19.1.0.166_mpiuni_g/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMFVERSIONGIT='ESMF_8_2_0_beta_snapshot_04-7-g3098c96bb1' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpiuni -DESMF_DIR=/scratch/cluster/mpotts/intel_19.1.0.166_mpiuni_g -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_MPIUNI

ESMF_CXXLINKOPTS=  -m64 -mcmodel=small -pthread -Wl,--no-as-needed  -qopenmp
ESMF_CXXLINKPATHS=-L/scratch/cluster/mpotts/intel_19.1.0.166_mpiuni_g/lib/libg/Linux.intel.64.mpiuni.default -L/usr/local/netcdf-c-4.7.4-f-4.5.2-intel-cluster-20.0.1/lib -L/usr/local/netcdf-c-4.7.4-f-4.5.2-intel-cluster-20.0.1/lib -L/usr/local/hdf5-1.12.0-intel-cluster-20.0.1/lib -L/usr/local/netcdf-c-4.7.4-f-4.5.2-intel-cluster-20.0.1/lib -L/usr/local/intel-cluster-20.0.1/compilers_and_libraries_2020.0.166/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/scratch/cluster/mpotts/intel_19.1.0.166_mpiuni_g/lib/libg/Linux.intel.64.mpiuni.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/scratch/cluster/mpotts/intel_19.1.0.166_mpiuni_g/lib/libg/Linux.intel.64.mpiuni.default -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-intel-cluster-20.0.1/lib -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-intel-cluster-20.0.1/lib -Wl,-rpath,/usr/local/hdf5-1.12.0-intel-cluster-20.0.1/lib -Wl,-rpath,/usr/local/netcdf-c-4.7.4-f-4.5.2-intel-cluster-20.0.1/lib -Wl,-rpath,/usr/local/intel-cluster-20.0.1/compilers_and_libraries_2020.0.166/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/scratch/cluster/mpotts/intel_19.1.0.166_mpiuni_g/lib/libg/Linux.intel.64.mpiuni.default
...
ESMF_TRACE_LDPRELOAD=/scratch/cluster/mpotts/intel_19.1.0.166_mpiuni_g/lib/libg/Linux.intel.64.mpiuni.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/scratch/cluster/mpotts/intel_19.1.0.166_mpiuni_g

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /scratch/cluster/mpotts/intel_19.1.0.166_mpiuni_g
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
