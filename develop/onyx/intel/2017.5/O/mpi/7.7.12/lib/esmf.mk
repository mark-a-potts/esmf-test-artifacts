...
ESMF_APPSDIR=/p/work/mpotts/intel_2017.5_mpi_O/apps/appsO/Unicos.intel.64.mpi.default
ESMF_LIBSDIR=/p/work/mpotts/intel_2017.5_mpi_O/lib/libO/Unicos.intel.64.mpi.default
...
ESMF_F90COMPILEPATHS=-I/p/work/mpotts/intel_2017.5_mpi_O/mod/modO/Unicos.intel.64.mpi.default -I/p/work/mpotts/intel_2017.5_mpi_O/src/include -I/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/include -I/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/include
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMFVERSIONGIT='ESMF_8_2_0_beta_snapshot_04-5-g9ad08a1743' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpi -DESMF_DIR=/p/work/mpotts/intel_2017.5_mpi_O
...
ESMF_CXXCOMPILEPATHS= -I/p/work/mpotts/intel_2017.5_mpi_O/src/include  -I/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/include -I/p/work/mpotts/intel_2017.5_mpi_O/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMFVERSIONGIT='ESMF_8_2_0_beta_snapshot_04-5-g9ad08a1743' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_MPIIO -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpi -DESMF_DIR=/p/work/mpotts/intel_2017.5_mpi_O -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_NO_POSIXIPC

ESMF_CXXLINKOPTS=  -pthread -Wl,--no-as-needed  -qopenmp
ESMF_CXXLINKPATHS=-L/p/work/mpotts/intel_2017.5_mpi_O/lib/libO/Unicos.intel.64.mpi.default -L/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/lib -L/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/lib -L/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/lib -L/p/app/unsupported/hdf5/1.8.18-intel-17.0.1.132/lib -L/p/app/unsupported/hdf4/4.2.12-nonetcdf-intel-17.0.1.132/lib -L/p/app/unsupported/szip/2.1.1-intel-17.0.1.132/lib -L/opt/intel/compilers_and_libraries_2017.1.132/linux/mkl/lib/intel64 -L/opt/intel/compilers_and_libraries_2017.5.239/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/p/work/mpotts/intel_2017.5_mpi_O/lib/libO/Unicos.intel.64.mpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/p/work/mpotts/intel_2017.5_mpi_O/lib/libO/Unicos.intel.64.mpi.default -Wl,-rpath,/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/lib -Wl,-rpath,/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/lib -Wl,-rpath,/p/app/unsupported/netcdf/4.4.1.1-intel-17.0.1.132/lib -Wl,-rpath,/p/app/unsupported/hdf5/1.8.18-intel-17.0.1.132/lib -Wl,-rpath,/p/app/unsupported/hdf4/4.2.12-nonetcdf-intel-17.0.1.132/lib -Wl,-rpath,/p/app/unsupported/szip/2.1.1-intel-17.0.1.132/lib -Wl,-rpath,/opt/intel/compilers_and_libraries_2017.1.132/linux/mkl/lib/intel64
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/p/work/mpotts/intel_2017.5_mpi_O/lib/libO/Unicos.intel.64.mpi.default
...
ESMF_TRACE_LDPRELOAD=/p/work/mpotts/intel_2017.5_mpi_O/lib/libO/Unicos.intel.64.mpi.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/p/work/mpotts/intel_2017.5_mpi_O

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /p/work/mpotts/intel_2017.5_mpi_O
# ESMF_OS: Unicos
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
