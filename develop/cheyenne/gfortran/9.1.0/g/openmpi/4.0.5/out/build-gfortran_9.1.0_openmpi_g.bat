...
cd /glade/scratch/mpotts/gfortran_9.1.0_openmpi_g
...
export ESMF_DIR=/glade/scratch/mpotts/gfortran_9.1.0_openmpi_g
...
ssh cheyenne6 /glade/scratch/mpotts/gfortran_9.1.0_openmpi_g/getres-build.sh
