...
ESMF_APPSDIR=/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_g/apps/appsg/Unicos.intel.64.mpiuni.default
ESMF_LIBSDIR=/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_g/lib/libg/Unicos.intel.64.mpiuni.default
...
ESMF_F90COMPILEPATHS=-I/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_g/mod/modg/Unicos.intel.64.mpiuni.default -I/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_g/src/include -I/opt/cray/pe/netcdf/4.6.3.2/include -I/opt/cray/pe/netcdf/4.6.3.2/INTEL/19.0/include
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpiuni -DESMF_DIR=/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_g -DESMF_MPIUNI
...
ESMF_F90LINKPATHS=-L/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_g/lib/libg/Unicos.intel.64.mpiuni.default -L/opt/cray/pe/netcdf/4.6.3.2/INTEL/19.0/lib 
ESMF_F90ESMFLINKPATHS=-L/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_g/lib/libg/Unicos.intel.64.mpiuni.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_g/lib/libg/Unicos.intel.64.mpiuni.default -Wl,-rpath,/opt/cray/pe/netcdf/4.6.3.2/INTEL/19.0/lib
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_g/lib/libg/Unicos.intel.64.mpiuni.default
...
ESMF_CXXCOMPILEPATHS= -I/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_g/src/include  -I/opt/cray/pe/netcdf/4.6.3.2/include -I/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_g/src/Infrastructure/stubs/mpiuni -I/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_g/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpiuni -DESMF_DIR=/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_g -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_MPIUNI -DESMF_NO_POSIXIPC

ESMF_CXXLINKOPTS=  -pthread -Wl,--no-as-needed  -qopenmp
ESMF_CXXLINKPATHS=-L/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_g/lib/libg/Unicos.intel.64.mpiuni.default -L/opt/cray/pe/netcdf/4.6.3.2/INTEL/19.0/lib -L/opt/intel/compilers_and_libraries_2019.5.281/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_g/lib/libg/Unicos.intel.64.mpiuni.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_g/lib/libg/Unicos.intel.64.mpiuni.default -Wl,-rpath,/opt/cray/pe/netcdf/4.6.3.2/INTEL/19.0/lib
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_g/lib/libg/Unicos.intel.64.mpiuni.default
...
ESMF_TRACE_LDPRELOAD=/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_g/lib/libg/Unicos.intel.64.mpiuni.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_g

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /lustre/f2/dev/ncep/Mark.Potts/intel_2019.5_mpiuni_g
# ESMF_OS: Unicos
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
