...
export ESMF_NETCDF=nc-config
export ESMF_DIR=/scratch1/NCEPDEV/da/Mark.Potts/sandbox/gfortran_9.2.0_openmpi_O_develop
...
ssh hfe02 /scratch1/NCEPDEV/da/Mark.Potts/sandbox/gfortran_9.2.0_openmpi_O_develop/runpython.sh 2>&1 | tee python_build.log
